...
LUMA_SEED_EVENTS_PATH = os.getenv(
    "LUMA_SEED_EVENTS_PATH", "resources/mock_events_munich.json"
)
...
GRAPH_PREF_UPDATE_WINDOW_SECONDS = int(
    os.getenv("GRAPH_PREF_UPDATE_WINDOW_SECONDS", "300")
)
GRAPH_PREF_MAX_UPDATES_PER_CATEGORY_WINDOW = int(
    os.getenv("GRAPH_PREF_MAX_UPDATES_PER_CATEGORY_WINDOW", "4")
)
GRAPH_PREF_DECAY_MAX_GAP_HOURS = int(os.getenv("GRAPH_PREF_DECAY_MAX_GAP_HOURS", "36"))
GRAPH_PREF_RETENTION_WALLET_SEED_DAYS = int(
    os.getenv("GRAPH_PREF_RETENTION_WALLET_SEED_DAYS", "30")
)
