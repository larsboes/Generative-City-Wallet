...
send_request(
    ...
    method="POST",
    data={"city":"München","category":"bar,cafe,restaurant","limit":10,"days":28,"seed":42}
)
...
send_request(
    ...
    method="POST",
    data={"city":"München","category":"bar,cafe,restaurant","limit":10,"seed":43}
)
...
try:
    with urllib.request.urlopen("http://127.0.0.1:8000/api/venues?category=bar,cafe&city=M%C3%BCnchen&limit=1") as response:
