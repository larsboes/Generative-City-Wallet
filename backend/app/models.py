...
DemandSignal = Literal["FLASH", "PRIORITY", "QUIET", "NORMAL", "NORMALLY_CLOSED"]
...
class DemandContext(BaseModel):
    ...
    current_occupancy_pct: float | None = Field(default=None, ge=0, le=1)
    predicted_occupancy_pct: float | None = Field(default=None, ge=0, le=1)
...
class TransactionGenerationRequest(BaseModel):
    merchant_ids: list[str] | None = Field(default=None, max_length=500)
    city: str | None = None
